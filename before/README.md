...
The starting point. Do not edit this directory; it is the fixed baseline the
series refactors away from.
...
Every item below is deliberate. This is the list the series works through.
